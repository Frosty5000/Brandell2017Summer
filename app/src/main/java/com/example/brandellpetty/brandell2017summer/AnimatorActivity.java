    ...
    private ValueAnimator doAnimatorListener(){
        ...
        animator.addListener(new Animator.AnimatorListener(){
            ...
            public void onAnimationStart(Animator animation) {
                shortToast("Started");
                UtilLog.d("Petty", "Animation start");
            }

            @Override
            public void onAnimationEnd(Animator animation) {
                shortToast("Ended");
                UtilLog.d("Petty", "Animation end");
            }

            @Override
            public void onAnimationCancel(Animator animation) {
                shortToast("Canceled");
                UtilLog.d("Petty", "Animation cancel");
            }

            @Override
            public void onAnimationRepeat(Animator animation) {
                shortToast("Repeated");
                UtilLog.d("Petty", "Animation repeat");
            }
        });
    ...
    public class ArgbEvaluator implements TypeEvaluator {
        public Object evaluate(float fraction, Object startValue, Object endValue){
            ...
            return (int)((startA + (int)(fraction *(endA-startA))) << 24) |
                    ...
                    (int)((startB + (int)(fraction *(endB-startB))) << 24);
